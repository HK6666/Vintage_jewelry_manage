    ...
    <div className="fade-in">
      ...
      <div className="px-4 sm:px-6 md:px-8 grid grid-cols-3 gap-3 sm:gap-4 mb-6">
        <div className="stat-card rounded-2xl p-3 sm:p-4 text-center">
          ...
          <p className="text-xl sm:text-2xl font-bold text-ink-800 font-heading mt-0.5 sm:mt-1">{categories.length}</p>
        </div>
        <div className="stat-card rounded-2xl p-3 sm:p-4 text-center">
        ...
        <div className="stat-card rounded-2xl p-3 sm:p-4 text-center">
          ...
          <p className="text-xl sm:text-2xl font-bold text-ink-800 font-heading mt-0.5 sm:mt-1">{categories.length ? Math.round(totalCount / categories.length) : 0}</p>
        </div>
      </div>
            ...
            <GlassCard key={cat.id} className="!p-4 sm:!p-5">
              ...
              <div className="flex items-center gap-4 pt-2 border-t border-ivory-200/60">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-xs sm:text-sm text-ink-500 hover:text-primary-500 hover:bg-primary-50/50 active:bg-primary-50 cursor-pointer transition-colors"
                >
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-xs sm:text-sm text-ink-500 hover:text-accent-500 hover:bg-accent-50/50 active:bg-accent-50 cursor-pointer transition-colors"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
