    ...
    <div className="fade-in">
      <div className="px-6 md:px-8 pt-8 pb-4">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            <h2 className="font-heading text-3xl font-bold text-ink-800">材质管理</h2>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-sm font-medium cursor-pointer transition-colors ${
                filterCat === cat
                  ...
                  : 'bg-white/60 text-ink-500 hover:bg-ivory-100 border border-ivory-200'
              }`}
            >
              {cat}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
              ...
              <div>
                ...
                <select
                  ...
                  className={`input-field w-full rounded-xl px-4 py-2.5 text-sm cursor-pointer appearance-none ${selectArrowBg}`}
                >
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="text-ink-400 hover:text-primary-500 cursor-pointer p-1"
                          title="编辑"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                          ...
                          className="text-ink-400 hover:text-accent-500 cursor-pointer p-1"
                          title="删除"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
